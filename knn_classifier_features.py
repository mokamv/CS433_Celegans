...
if PLOT_CONFUSION_MATRIX:
    ...
    plt.tight_layout()
    plt.savefig('Figures/feature_knn_confusion_matrix.png', dpi=300)
    print("\nConfusion matrix saved to Figures/feature_knn_confusion_matrix.png")
...
if PLOT_K_ANALYSIS:
    ...
    plt.tight_layout()
    plt.savefig('Figures/feature_knn_k_analysis.png', dpi=300)
    print("K-value analysis plot saved to Figures/feature_knn_k_analysis.png")
